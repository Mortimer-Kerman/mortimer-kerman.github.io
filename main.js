...
document.querySelectorAll('div.modrinth-logo').forEach((logo) => {
    const svgElement = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
...
document.querySelectorAll('div.curseforge-logo').forEach((logo) => {
    ...
    svgElement.setAttribute('class', logo.getAttribute('class'));
    svgElement.setAttribute('fill', '#FFFFFF');
    svgElement.innerHTML = `<path d="M29.4889 15.285C29.4889 15.285 36.8392 14.1158 38 10.7058H26.7401V8H2L5.0477 11.5674V15.2225C5.0477 15.2225 12.7377 14.8191 15.7124 17.0946C19.7842 20.9017 11.1328 26.048 11.1328 26.048L9.64927 31C11.9691 28.7718 16.3905 25.8892 24.4969 26.0282C21.412 27.0117 18.3101 28.5478 15.8952 31H32.2824L30.7393 26.048C30.7393 26.048 18.8623 18.9833 29.4889 15.2855V15.285Z"/>`;
    logo.parentNode.replaceChild(svgElement, logo);
});

document.querySelectorAll('div.mail-logo').forEach((logo) => {
    const svgElement = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    ...
    svgElement.setAttribute('class', logo.getAttribute('class'));
    svgElement.setAttribute('fill', '#FFFFFF');
    svgElement.innerHTML = `<path d="M172-126q-53 0-89.5-36.5T46-252v-456q0-53 36.5-89.5T172-834h616q53 0 89.5 36.5T914-708v456q0 53-36.5 89.5T788-126H172Zm308-283q9 0 17.5-2.5T514-419l252-164q9-5 15.5-15.5T788-622q0-26-23.5-40.5T716-661L480-508 244-661q-24-15-48-2t-24 41q0 14 6.5 24t15.5 15l252 164q8 5 16.5 7.5T480-409Z"/>`;
    logo.parentNode.replaceChild(svgElement, logo);
});
